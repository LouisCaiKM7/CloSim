...
namespace Utilities
{
    public class Utils : MonoBehaviour
    {
        ...
        {
            return TryGetAddChild(childName, parent, out _);
        }

        /// <summary>
        /// Finds the first Parent object which contains a rigid body
        /// </summary>
        ...
        /// <summary>
        /// Finds the first Parent object which contains an object T
        /// </summary>
        /// <param name="child"></param>
        /// <returns></returns>
        ...
        private static readonly Dictionary<GameObject, Component> ParentComponentCache =
