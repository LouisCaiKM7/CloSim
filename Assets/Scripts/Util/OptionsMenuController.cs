...
public class OptionsMenuController : MonoBehaviour
{
    ...
    [SerializeField] private bool resetOnCancel = false;
    [SerializeField] private bool unlockCursorWhenOpen = true;
    [SerializeField] private bool relockCursorOnClose = false;
    ...
    private void ResolveToggleAction()
    {
        ...
        {
            _resolvedToggleAction = fallbackActions.FindAction(fallbackToggleActionName, false);
            if (_resolvedToggleAction != null)
                return;
        }
    ...
    public void OpenMenu()
    {
        ...
        Action showMenu = () =>
        {
            ...
            if (debugLogs)
                Debug.Log("OptionsMenuController: menu opened.");
        };
    ...
    public void ApplyAndClose()
    {
        ...
        Action applyAndReset = () =>
        {
            ...
            if (debugLogs)
                Debug.Log("OptionsMenuController: applied settings and reset field.");
        };
    ...
    public void CloseMenuWithoutApply(bool resetField)
    {
        if (_isTransitioning)
            return;
        ...
        Action closeAction = () =>
        {
            ...
            if (debugLogs)
                Debug.Log("OptionsMenuController: closed without apply.");
        };
    ...
    private void RefreshPanel(int panelIndex)
    {
        ...
        panel.SetSpawnOptions(spawnNames, selectedSpawnIndex, true);
    }
    ...
    private void SetRobotInputsEnabled(bool enabled)
    {
        if (loadMatch == null)
            return;
